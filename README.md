...
This Privacy Policy applies to the mobile applications "Slap It! - Physical Soundboard" and "Slap It! Pro - Soundboard" (hereinafter referred to as "the App"), created by ThinkQuack.

We built the App as a Commercial ad-free app. This SERVICE is provided by ThinkQuack and is intended for use as is.

Our Privacy Policy is simple: We do not collect, encrypt, transmit, or share any of your personal data.

1. No Data Collection & No Analytics
The App operates entirely offline and locally on your device. We do not use third-party analytics (such as Google Analytics or Firebase Crashlytics), we do not use advertising frameworks, and we do not collect any crash reports or usage metrics.

You do not need an account to use the App.
The App makes zero network requests to external servers.
